      ...
      value: function draw(_ref2) {
        ...
        if (fit == 'cover'){
          if (width / height > aspectRatio) {
            var destX = -width / 2;
            var destY = -width * naturalHeight / naturalWidth / 2;
            var destWidth = width;
            var destHeight = width * naturalHeight / naturalWidth;
          } else {
            var destX = -height * naturalWidth / naturalHeight / 2;
            var destY = -height / 2;
            var destWidth = height * naturalWidth / naturalHeight;
